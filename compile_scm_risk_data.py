...
def compile_management_stability():
    ...
    warning_history = [
        ["센싱일자", "협력업체", "품목군", "年거래액(억원)", "위험 분류", "진행 상태", "세부 내용", "Risk"],
        ["2026-09-04", "Toshiba Memory", "Memory", "5.5", "M&A/지배구조", "진행중", "Kioxia 합병 추진 실사 및 미국 사모펀드 인수 실사 진행에 따른 공급선 주도권 변동 주시", "중"],
        ["2026-09-01", "STMicroelectronics", "IC", "3.5", "노사분규", "주시", "필리핀 현지 생산 공장 임금 인상 조율 결렬 및 부분 노조 태업으로 인한 OSAT 물량 인도 차질 우려", "상"],
        ["2026-08-27", "TDK Corporation", "Passive", "12.5", "승계/경영권", "완료", "창업주 일가 은퇴 및 전문경영인 이사회 승계 절차 돌입, 중장기 부품 사업 포트폴리오 영향 모니터링", "하"],
        ["2026-08-22", "Yageo Corporation", "Passive", "24.2", "경영난", "진행중", "단기 자금 유동비율 급감 및 대만 현지 은행단 긴급 워크아웃 채무 유예 조정안 실사 착수", "상"],
        ["2026-08-15", "Murata Mfg", "Passive", "0.5", "생산차질", "주시", "일본 내륙 정밀 제련 자회사 가동 제한 권고 및 핵심 원자재 공급 라인 정밀 소독 다운타임", "중"]
    ]
